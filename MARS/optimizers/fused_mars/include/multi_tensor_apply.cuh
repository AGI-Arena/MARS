...
// constexpr int depth_to_max_tensors[7] = {110, 64, 48, 36, 30, 24, 24};
// constexpr int depth_to_max_blocks[7] = {320, 320, 320, 320, 320, 320, 320};
// constexpr int depth_to_max_tensors[6] = {110, 64, 48, 36, 30, 24};
constexpr int depth_to_max_tensors[6] = {128, 128, 128, 128, 128, 128};
