...
optimizer = Moonlight(lr=learning_rate, wd=weight_decay, muon_params=muon_params, adamw_params=adamw_params,
                   momentum=beta1, adamw_betas=betas_1d)
if init_from == 'resume':
